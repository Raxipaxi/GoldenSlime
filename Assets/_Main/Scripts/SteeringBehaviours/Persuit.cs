...
public class Pursuit : ISteering
{
    ...
    public Pursuit(Transform self, Transform target, float vel, float timePrediction)
    {
        _self = self;
        _target = target;
        _vel = vel;
    ...
    {
        float directionMultiplier = (_vel * _timePrediction);
        ...
        Vector3 dir = (finitPos - _self.position).normalized;
        return dir;
    }
}